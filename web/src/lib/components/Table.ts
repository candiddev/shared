  ...
  return {
      ...
      history[route] = {
        scroll: (
          document.getElementById(
            `tablediv${StringToID(vnode.attrs.id)}`,
          ) as HTMLElement
        ).scrollTop,
        sort: vnode.attrs.sort === undefined ? undefined : vnode.attrs.sort(),
    ...
    onupdate: (vnode): void => {
      if (vnode.attrs.loaded && !scrolled && history[route] !== undefined) {
        ...
        ).scrollTop = history[route].scroll;
        scrolled = true;
      }
    },
    view: (vnode): m.Children => {
      return m(
        ...
        [
          m(Title, vnode.attrs.title === undefined ? {} : vnode.attrs.title),
          m(Toolbar, {
                ...
                : [
                    {
                      ...
                      onclick: (e: string): void => {
                        if (
                          vnode.attrs.tableColumnsNameEnabled()[e] === undefined
                        ) {
                      ...
                      value: vnode.attrs.tableColumns.reduce(
                        (arr, column) => {
          ...
          [
            m(
              `div.Table__div#tablediv${StringToID(vnode.attrs.id)}`,
              m(
                "table.Table",
                {
                ...
                [
                    ...
                    vnode.attrs.loaded
                      ? vnode.attrs.data === null
                        ...
                        : vnode.attrs.data.map(
                            ...
                            (data: any, i: number): m.Children => {
                              const id = StringToID(
                                vnode.attrs.getKey === undefined
                                  ? data.id
                                  : vnode.attrs.getKey(data),
                                true,
                              );
                              ...
                              return m(
                                ...
                                {
                                  class:
                                    vnode.attrs.editOnclick !== undefined &&
                                  ...
                                  onclick:
                                    ...
                                    AppState.isSessionOnline()
                                      ? async (): Promise<void> => {
                                          if (
                                            vnode.attrs.editOnclick !==
                                            undefined
                                          ) {
                                            await vnode.attrs.editOnclick(
                                              vnode.attrs.data[i],
                                            );
                                          }
                                        }
                                ...
                                [
                                  vnode.attrs.tableColumns.map(
                                    (column: TableColumnAttrs): m.Children => {
                                      return Object.keys(
                                        vnode.attrs.tableColumnsNameEnabled(),
                                        ...
                                        ? m(TableData, {
                                            checkboxOnclick: async () => {
                                              if (
                                                ...
                                                return column.checkboxOnclick(
                                                  Clone(data),
                                                );
                                              }
                                            },
                                            collapsedNames:
                                              column.collapsedNames,
                                            currencyFormat:
                                            ...
                                            linkRequireOnline:
                                              column.linkRequireOnline,
                                            name: column.name,
                                            onclick: column.onclick,
                                            ondragend: column.ondragend,
                                            permitted: () => {
                                              if (
                                                column.permitted !== undefined
                                              ) {
                                                return column.permitted(
                                                  vnode.attrs.data[i],
                                                );
                                              }
                      ...
                      : [...Array(5)].map(() => {
                          return m(
                            `tr.Table__loading.${Animate.class(Animation.Pulse)}`,
                            vnode.attrs.tableColumns.map(
                              (column: TableColumnAttrs): m.Children => {
                                return Object.keys(
                                  vnode.attrs.tableColumnsNameEnabled(),
                  ...
                  vnode.attrs.loaded &&
                  (vnode.attrs.data === null || vnode.attrs.data.length === 0)
                    ? m("div.Table__none", [
                        ...
                        vnode.attrs.noNewButton === true
                          ? []
                          : AppState.data.layoutAppToolbarActionButtons.map(
                              (action) => {
                                if (
                                  (action.permitted &&
                                    AppState.isSessionOnline()) ||
                                  !action.requireOnline
                                ) {
                                  return m(Button, {
                                    icon: Icons.Add,
