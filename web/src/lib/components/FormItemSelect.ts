      ...
      return [
        m(
          "select.FormItem__field",
          {
            ...
            size:
              vnode.attrs.multiple === true &&
              typeof vnode.attrs.options === "object"
            ...
            if (typeof option === "object") {
              return m(
                "option",
                {
                  ...
                  style: {
                    color:
                      option.color === undefined ? undefined : option.color,
                  },
                  value: option.id === undefined ? option.name : option.id,
                },
                option.name,
              );
            }
                ...
                "span.GlobalLink",
                {
                  ...
                  onclick: () => {
                    const el = document.getElementById(
                      `form-item-select${StringToID(vnode.attrs.name)}`,
