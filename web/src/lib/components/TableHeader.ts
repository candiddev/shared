  ...
  return {
    oncreate: (vnode): void => {
      const table = document.getElementById(
        `table${
          vnode.attrs.id === undefined ? "" : StringToID(vnode.attrs.id)
        }`,
      );
      if (table !== null) {
    ...
    view: (vnode): m.Children => {
      return m("thead", [
                ...
                return Object.keys(
                  ...
                  ? m(
                      "th.TableHeader",
                      {
                        class: SetClass({
                          "TableHeader--center":
                            column.type === TableDataType.Checkbox ||
                            column.type === TableDataType.Drag ||
                            column.type === TableDataType.Image,
                          "TableHeader--right":
                            column.rightAlign === true ||
                            column.type === TableDataType.Currency,
                        }),
                          ...
                          "div.TableHeader",
                          {
                            class: SetClass({
                              "TableHeader--active":
                                ...
                                vnode.attrs.sort().property === column.property,
                              "TableHeader--pointer":
                                vnode.attrs.sort !== undefined,
                            }),
                          },
        ...
        m(
          "tr.TableHeader__filter",
          m(
            `div.${Animate.class(Animation.Fade)}`,
            {
            ...
            state.filterProperty === ""
              ? []
              : [
                  vnode.attrs.tableColumns[
                    vnode.attrs.tableColumns.findIndex((column) => {
                  ...
                  m(FormItem, {
                    ...
                    name: state.filterName,
                    tooltip:
                      AppState.data.translations.tableHeaderFilterTooltip,
                  }),
                  m(Icon, {
                    icon: Icons.Close,
                    onclick: async (e: m.Event<MouseEvent>) => {
