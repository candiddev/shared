...
export function AppMenuComponent(): m.Component<AppMenuComponentAttrs> {
  return {
    ...
    oninit: (vnode): void => {
      ...
      vnode.attrs.views().map(async (view: AppMenuComponentView | null) => {
    ...
    view: (vnode): m.Children => {
      return m(
        "ul.AppMenu__menu.AppMenu__menu--comp",
        {
          class: AppState.getLayoutAppMenuPath().startsWith(
            `/${vnode.attrs.cLower}`,
          )
            ? "AppMenu__menu--open"
            : undefined,
        ...
        [
          vnode.attrs
            ...
            .map((v: AppMenuComponentView | null): m.Children => {
              if (
                v === null ||
                (!AppState.isSessionOnline() && v.requireOnline === true)
              ) {
                return [];
              }
              ...
              return [
                  ...
                  "li.AppMenu__entry",
                  {
                    class: SetClass({
                      "AppMenu__entry--active":
                        v.icon !== undefined &&
                        ((v.matchExact === true && m.route.get() === vRoute) ||
                          (v.matchExact !== true &&
                            m.route.get().includes(vRoute))),
                  ...
                  [
                    m(
                      v.icon === undefined
                        ...
                        : m.route.Link,
                      {
                        href: v.icon === undefined ? undefined : vRoute,
                        ...
                        target: vRoute.startsWith("/") ? undefined : "_blank",
                      },
                      [
                        v.items !== undefined || v.nested !== undefined
                          ? []
                ...
                v.itemsRequireOnline === undefined ||
                (v.itemsRequireOnline === true && AppState.isSessionOnline())
                  ? v.nested === undefined
                    ? v.items !== undefined && v.items().length > 0
                      ? m(AppMenuComponentView, {
                          ...
                          vLower: vLower,
                          vroute:
                            v.link !== undefined && v.link.startsWith("?")
                              ? `/${vnode.attrs.cLower}`
                              : vRoute,
                        })
                      : []
