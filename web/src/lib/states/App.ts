...
import type {
  FormItemAutocompleteParseOutput,
  FormItemAutocompleteParser,
} from "@lib/components/FormItem";
...
import {
  ...
  ActionView,
  AlertNewVersion,
  AppToolbarActionsOnThisPage,
  ColorCustom,
  FormCreated,
  FormImageSelect,
  FormImportCSVField,
  FormImportCSVSelectCSV,
  FormImportCSVTooltip,
  FormItemDurationHour,
  FormItemDurationHours,
  FormItemDurationMinute,
  FormItemDurationMinutes,
  FormItemInputIconName,
  FormItemInputIconTooltip,
  FormItemNewPasswordPassword,
  FormItemNewPasswordTooltip,
  FormItemSelectColorName,
  FormItemSelectColorTooltip,
  FormItemSelectCurrencyFormat,
  ...
  FormRecurrenceFirst,
  FormRecurrenceFourth,
  FormRecurrenceFourthToLast,
  FormRecurrenceLabel,
  FormRecurrenceLast,
  FormRecurrenceMonths,
  FormRecurrenceNextDate,
  FormRecurrenceSecond,
  FormRecurrenceSecondToLast,
  FormRecurrenceSpecificDate,
  FormRecurrenceThird,
  FormRecurrenceThirdToLast,
...
function New(): App {
  return {
    ...
    translations: {
      ...
      formItemSelectColorTooltip: "",
      formItemSelectColorValues: Object.keys(ColorEnum).map((color) => {
        return {
          id: color,
      ...
      formPermissionTypes: ["Edit", "View", "None"],
...
export const AppState = {
  ...
  init: (
    ...
    AppState.preferences = preferences.map((preferences) => {
      ...
      const colors = {
        ...
        secondary: Color.toHex(
          preferences.colorSecondary,
      ...
      AppState.style = {
        ...
        "--color_base-1": preferences.darkMode ? "#111827" : "#ffffff",
        "--color_base-2": preferences.darkMode ? "#1f2937" : "#eceff1",
        "--color_base-3": preferences.darkMode ? "#374151" : "#cfd8dc",
        "--color_content": Color.toHex(
          preferences.darkMode ? Color.content.white : Color.content.black,
        ),
        "--color_content-invert": Color.toHex(
          preferences.darkMode ? Color.content.black : Color.content.white,
        ),
        "--color_negative": Color.toHex(
          preferences.colorNegative,
          preferences.darkMode,
        ),
        "--color_positive": Color.toHex(
          preferences.colorPositive,
          preferences.darkMode,
        ),
  ...
  setComponentsDropdownMenu: (id: string, x: number): void => {
    AppState.set({
      componentsDropdownMenu:
        id === AppState.data.componentsDropdownMenu ? "" : id,
  ...
  setLayoutApp: (data: {
    ...
    if (data.breadcrumbs.length === 0) {
      ...
      document.title = `${AppState.product} - ${data.breadcrumbs
        .map((breadcrumb) => {
  ...
  setLayoutAppAlert: (alert: AppAlert, hidden?: boolean): void => {
    ...
    if (alert.persist !== true) {
      setTimeout(
        ...
        process.env.NODE_ENV === "test" ? 300 : 1500,
      );
    }
  ...
  setLayoutAppForm: (
    ...
    component?: () => m.Component<FormOverlayComponentAttrs<any>>,
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    data?: any,
  ): void => {
    AppState.set({
      layoutAppForm: {
        ...
        data:
          data === undefined ? AppState.data.layoutAppForm.data : Clone(data),
      },
    });
    m.redraw();
  },
  ...
  setSessionISO639: (code: ISO639Code): void => {
    AppState.set({
      translations: {
        ...
        appToolbarActionsOnThisPage: Translate(
          code,
          AppToolbarActionsOnThisPage,
        ),
        ...
        formItemNewPasswordPassword: Translate(
          code,
          FormItemNewPasswordPassword,
        ),
        ...
        formItemSelectColorValues: Object.keys(ColorEnum).map((key) => {
          return {
            id: key,
            name: Translate(code, ColorEnum[key].translation),
          };
        }),
        formItemSelectCurrencyFormat: Translate(
          code,
          FormItemSelectCurrencyFormat,
        ),
        formItemSelectCurrencyFormatTooltip: Translate(
          code,
          FormItemSelectCurrencyFormatTooltip,
        ),
  ...
  toggleSessionSleepDisabled: async (): Promise<void> => {
    AppState.set({
