...
var (
	ErrCreatingCertificate    = errors.New("error creating certificate")
	...
	ErrDecodingCertificate    = errors.New("error decoding base64 der X.509 certificate")
	...
	ErrParsingSSH             = errors.New("error parsing SSH key")
